...
urlpatterns = [
    ...
    path('chat_request/', ChatRequestApiView.as_view(), name="api_chat_request"),
    path('sub_request/', SubscriptionLevelRequestApiView.as_view(), name="api_sub_request"),
    path('sub_level/', SubscriptionLevelApiView.as_view(), name="api_sub_level"),
    path('sub_level/<int:pk>', SubscriptionLevelDetailApiView.as_view(), name="api_sub_level_detail"),
    path('request/', RequestApiView.as_view(), name="api_request"),
    path('request_all/', AdminRequestListApiView.as_view(), name="api_request_all"),
    path('request/<int:pk>', AdminRequestDetailApiView.as_view(), name="api_request_detail"),
